...
(function() {
  ...
  Evernote.ContentClipper.PREVIEW_ARTICLE_CLASS = "evernotePreviewArticleContainer";
  ...
  Evernote.ContentClipper.prototype.fetchStyleSheet = function(href, callback) {
    ...
    chrome.extension.sendRequest(new Evernote.RequestMessage(
        Evernote.Constants.RequestType.FETCH_STYLE_SHEET_RULES, href),
  ...
  Evernote.ContentClipper.prototype.createClipObject = function(stylingStrategy) {
    var self = this;
